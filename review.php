...
<div class="background_">
  ...
  <form id="feedback" action="">
    ...
    <button style="background-color: rgb(135, 203, 185);border-color: rgb(135, 203, 185);color: #009432; border-radius:10px" type="submit" class="btn btn-primary">Submit</button>
  ...
  <div class="review-view">
    ...
    <div class="review">
      <div class="review-info">
        <span class="review-rating">4.5</span> <div class="star"><i class="fa-solid fa-star" style="color: #faf200;"></i></div>
        <span class="review-name">John Doe</span>
      </div>
      <div class="review-comment">
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed luctus mi vel justo laoreet, ac tincidunt neque gravida.</p>
